...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      {/* Decorative circles */}
      <div className="absolute top-[-80px] left-[-80px] w-80 h-80 rounded-full bg-teallt/40 blur-3xl pointer-events-none" />
      <div className="absolute bottom-[-80px] right-[-80px] w-80 h-80 rounded-full bg-ocean/20 blur-3xl pointer-events-none" />
      <div className="absolute top-1/2 left-1/4 w-48 h-48 rounded-full bg-teal/10 blur-2xl pointer-events-none" />
      ...
      <div className="relative w-full max-w-[420px]">
        ...
        {/* Card */}
        <div className="bg-white/70 backdrop-blur-sm border border-teallt/60 rounded-3xl p-8 shadow-xl shadow-ocean/10">

          {/* Mode tabs */}
          <div className="flex rounded-xl bg-ivory border border-teal/20 mb-6 p-1">
            ...
            {mode === "register" && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-teallt bg-ivory text-ocean placeholder-teal/50 focus:outline-none focus:ring-2 focus:ring-ocean/30 focus:border-ocean transition text-sm"
                  required
                />
              </div>
            )}
